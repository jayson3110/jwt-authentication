/*
  ...
  File AuthController.js này sẽ bao gồm 2 controller 
  login – thực hiện chức năng đăng nhập, tạo token và
  controller refreshToken – làm mới lại token khi hết hạn 
...
// Thời gian sống cua refreshToken 
...
let login = async (req,res) => {
	try {
      ...
      // lưu ý trong dự án thực tế, nên lưu chỗ khác, có thể lưu vào Redis hoặc DB
        ...
        tokenList[refresToken] = {accessToken, refreshToken};
